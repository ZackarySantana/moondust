...
export const ResizeHandle: Component<ResizeHandleProps> = (props) => {
    ...
    return (
        <div
            class={`group/handle relative z-10 flex shrink-0 items-center justify-center ${
                isVertical()
        ...
        >
            <div
                class={`rounded-full bg-slate-700 transition-colors group-hover/handle:bg-emerald-500/50 ${
