...
/**
 * Common shell for git action dialogs: overlay, keyboard (Escape → close,
 * Enter → confirm), error banner, and Cancel / action button pair.
 *
 * For dialogs that contain a `<textarea>`, set `hasTextarea` so that plain
 * Enter inserts a newline and only **Cmd/Ctrl + Enter** confirms.
 */
const GitActionDialog: Component<{
    open: boolean;
    title: string;
    pending: boolean;
    error: string;
...
export const DiscardFileGitDialog: Component<{
    open: boolean;
    filePath: string;
    pending: boolean;
    error: string;
