...
export const SHORTCUT_ACTIONS: readonly ShortcutActionDef[] = [
    ...
    {
        id: "go_thread_slot_1",
        label: "Recent thread 1",
        description: "Open the first thread in the Recent list (sidebar)",
        tier: "navigational",
    },
    {
        id: "go_thread_slot_2",
        label: "Recent thread 2",
        description: "Open the second thread in the Recent list",
        tier: "navigational",
    },
    {
        id: "go_thread_slot_3",
        label: "Recent thread 3",
        description: "Open the third thread in the Recent list",
        tier: "navigational",
    },
    {
        id: "go_thread_slot_4",
        label: "Recent thread 4",
        description: "Open the fourth thread in the Recent list",
        tier: "navigational",
    },
    {
        id: "go_thread_slot_5",
        label: "Recent thread 5",
        description: "Open the fifth thread in the Recent list",
        tier: "navigational",
    },
    {
        id: "go_thread_slot_6",
        label: "Recent thread 6",
        description: "Open the sixth thread in the Recent list",
        tier: "navigational",
    },
...
const MAC_DEFAULTS: Record<ShortcutActionId, string> = {
    ...
    go_thread_slot_1: "Alt+1",
    go_thread_slot_2: "Alt+2",
    go_thread_slot_3: "Alt+3",
    go_thread_slot_4: "Alt+4",
    go_thread_slot_5: "Alt+5",
    go_thread_slot_6: "Alt+6",
